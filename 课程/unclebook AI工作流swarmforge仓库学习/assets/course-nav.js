...
(function () {
  ...
  const lessons = [
    ...
    { file: "0002-two-pack-complete-loop.html", label: "0002 two" },
    { file: "0003-four-pack-complete-loop.html", label: "0003 four" },
    { file: "0004-six-pack-complete-loop.html", label: "0004 six" },
  ];

  const refs = [
    { file: "swarmforge-map.html", label: "总地图" },
    { file: "glossary.html", label: "术语" },
    { file: "two-pack-flow.html", label: "two 流程" },
    { file: "four-pack-flow.html", label: "four 流程" },
