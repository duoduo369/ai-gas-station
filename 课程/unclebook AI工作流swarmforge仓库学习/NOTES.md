...
- 术语表把 BDD、Gherkin、CRAP、git_handoff 加厚。teach 嵌入权威中文见 [playbook/teach-课件-嵌入权威中文prompt.md](../../playbook/teach-课件-嵌入权威中文prompt.md)。
