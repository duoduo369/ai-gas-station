...
(function () {
  ...
  const lessons = [
    { file: "0001-repo-map-and-basic-workflow.html", label: "0001 地图" },
    { file: "0002-how-the-workflow-actually-finishes.html", label: "0002 收口" },
    { file: "0003-when-implementation-drifts-from-spec.html", label: "0003 跑偏" },
    { file: "0004-qa-bug-flow-and-where-worktrees-fit.html", label: "0004 终课" },
  ];

  const refs = [
    { file: "superpowers-project-and-flow-map.html", label: "项目地图" },
    { file: "implementation-loop-and-finish.html", label: "实现收口" },
    { file: "implementation-drift-decision-map.html", label: "跑偏分流" },
    { file: "qa-bug-flow-and-worktree-positioning.html", label: "终课速查" },
  ];
