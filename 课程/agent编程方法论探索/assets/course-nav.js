...
(function () {
  ...
  const lessons = [
    { file: "0001-agent-failure-modes.html", label: "0001 失败模式" },
    { file: "0002-three-methodologies-by-axes.html", label: "0002 对照轴" },
    { file: "0003-spec-as-entry-vs-artifact.html", label: "0003 spec 判断" },
  ];
