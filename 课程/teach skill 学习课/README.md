...
这门课用 `/teach` 学 `teach`。对象是这张卡，不是某门编程课的内容。
...
- 指认教学工作区里每份文件干什么
- 看出本库存课时还要再套 `playbook/teach-me.md`
...
- [0001 · 工作区怎么转起来，以及何时打 /teach](./lessons/0001-teach-workspace-and-how-to-invoke.html) - 工作区七件套，以及第一句怎么打：GitHub 仓库、日常技能、钉资料、续课。
