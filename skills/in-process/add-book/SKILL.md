...
在本仓库里为一本技术书创建 `书籍/<书名>.md`，并同步更新 `书籍/README.md`。
...
1. 锁定书名、目标文件和索引落点。
   完成标准：已经确定 `书籍/<书名>.md` 的文件名、`书籍/README.md` 里要放到哪个分组；如果用户没有额外限定，默认把“添加书籍”理解成“创建新 md + 补索引”。如果目标文件已存在，直接停下说明，不重复创建，也不改写已有正文。
2. 补齐可查的书目信息。
